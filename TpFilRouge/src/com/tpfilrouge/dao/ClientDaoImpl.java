...
import static com.tpfilrouge.dao.DAOUtilitaire.fermeturesSilencieuses;
import static com.tpfilrouge.dao.DAOUtilitaire.initialisationRequetePreparee;
...
public class ClientDaoImpl implements ClientDao {
   ...
   /*
    * Méthode générique utilisée pour retourner un client depuis la base de données, correspondant à
    ...
    * issue de la table des clients (un ResultSet) et un bean Client.
    */
