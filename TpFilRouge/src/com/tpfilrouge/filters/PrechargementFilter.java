package com.tpfilrouge.filters;
...
import com.tpfilrouge.dao.DAOFactory;
...
public class PrechargementFilter implements Filter {
   ...
   public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException,
      ...
      /*
       * Si la map des clients n'existe pas en session, alors l'utilisateur se connecte pour la
       * première fois et nous devons précharger en session les infos contenues dans la BDD.
       */
